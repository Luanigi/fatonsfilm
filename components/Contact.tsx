    ...
    <footer className="bg-black text-gray-300 overflow-x-hidden" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 md:pt-16 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="max-w-[350px] m-auto sm:m-0">
            <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Bleib im Kontakt!</h3>
            <div className="grid space-y-2 sm:space-y-3 mt-4 max-w-[350px]">
              <div className="flex flex-row sm:flex-row gap-2 w-full max-w-[350px] sm:max-w-[500px] sm:w-[500px]">
              ...
              <Link href="https://www.instagram.com/faton.ca/" target="_blank" className="max-w-[350px] md:max-w-full sm:w-[390px] w-full hover:text-white hover:bg-white/10 transition-colors py-2 px-4 flex items-center justify-center sm:justify-start border-white border-2 rounded">
                <Instagram className="h-4 w-4 sm:h-5 sm:w-5 mr-2" />
                <span>Instagram</span>
              </Link>

              <div className="flex flex-row sm:flex-row gap-2 w-full sm:w-[500px] max-w-[350px] md:max-w-full">
