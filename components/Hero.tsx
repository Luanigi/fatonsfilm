...
export default function Hero() {
  return (
    <section id="home" className="h-[100dvh] bg-cover bg-center flex items-center justify-center">
      <div className="text-center text-white lg:mt-0 mt-20">
      ...
      <Link href="/#projekte">
          <button className="flex m-auto bg-zinc-500 p-2.5 md:w-2/6 rounded-lg mt-4 hover:-translate-y-2 transition duration-200 hover:bcktst">
