    ...
    return (
      <section id="portfolio" className="py-16 bg-black text-white pt-[600px] md:pt-0">
        ...
        <div className="w-full text-center flex mb-10">
          <iframe className="mx-auto" width="800" height="512" src="https://www.youtube.com/embed/tqWXHpQYxYQ" title="Why Dostoevsky would HATE Nietzsche" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        </div>
        ...
        <div className="h-[30dvh] md:mx-40 mx-10 grid grid-cols-2 gap-6 items-center justify-center">
